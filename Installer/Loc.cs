...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
    {
        ...
        [Korean] = new Dictionary<string, string>
        {
            ...
            ["KrRuntimeNoDotnet"] = ".NET을 찾지 못했다: {0}. DALAMUD_RUNTIME을 걸지 못했고, 이 값이 없으면 게임 안에서 Dalamud가 뜨지 않는다. 아무 데서도 오류로 알려 주지 않는다.",
            ["KrRuntimeGetDotnet"] = ".NET 데스크톱 런타임을 설치한 뒤 이 프로그램을 다시 실행한다.",
            ...
            ["KrWaitingForDalamud"] = "Dalamud 설치가 끝나기를 기다린다. 최대 {0}분. 이 창은 닫지 마라.",
            ["KrDalamudArrived"] = "Dalamud가 설치됐다. 이어서 진행한다.",
            ["KrDalamudWaitGaveUp"] = "{0}분을 기다렸는데 Dalamud가 아직 없다. 설치가 끝나면 이 프로그램을 다시 실행한다.",
            ["KrUpdaterGetByHand"] = "업데이터가 아직 그 자리에 없다. 여기서 받는다:",
            ["KrRepoRegistered"] = "저장소를 등록했다: {0}",
            ["KrRepoListMissing"] = "설정에 저장소 목록이 없다. 모드는 돌지만 새 판을 알아서 받지는 못한다.",
            ["KrRepoManifestPointed"] = "설치한 사본을 그 저장소에 이었다.",
            ["KrRepoManifestFailed"] = "설치한 사본을 저장소에 잇지 못했다: {0}. 적재는 되지만 새 판을 알아서 받지는 못한다.",
            ...
            ["KrGetFromReleasePage"] = "모드 압축은 여기서 받는다:",
            ...
            ["KrDevInstallStuck"] = "예전 개발용 설치를 못 지웠다: {0} ({1}). 게임을 끄고 다시 실행한다. 그대로 두면 같은 플러그인을 두 번 불러온다.",
            ...
            ["AccessibilityUpdated"] = "접근성 모드를 {0}으로 업데이트했다.",
            ...
            ["AccessibilityUnexpectedError"] = "접근성 모드 처리 중 예상 못 한 오류: {0}",
            ["ErrorGeneric"] = "실패",
            ...
            ["VnavmeshUpdated"] = "vnavmesh를 {0}으로 업데이트했다.",
            ...
            ["ConfigNotExist4"] = "그래야 플러그인을 켤 수 있다.",
            ...
            ["ConfigUnexpectedStructure"] = "설정 구조가 예상과 다르다 (DevPluginLoadLocations 없음).",
            ...
            ["UnexpectedErrorWhere"] = "어디까지 갔는지는 위의 진행 상황 줄에서 읽는다.",
