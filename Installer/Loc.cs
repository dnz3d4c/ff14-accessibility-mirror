...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
    {
        ...
        [Korean] = new Dictionary<string, string>
        {
            ...
            // TTS로 말하는 문장은 명사형이나 해라체지만(ko-localization 스킬),
            // 이 창은 설치 절차를 한 번 읽고 끝내는 자리라 사용 안내 문서와 같은
            // 말투를 쓴다. 실제로 사용 안내가 여기 문장을 그대로 인용한다.
            ["WarnPrefix"] = "경고: ",
            ["ErrorPrefix"] = "실패: ",
            ...
            ["KrProfileCreated"] = "없던 것을 만들었습니다: {0}",
            ["KrRuntimeVariableSet"] = "DALAMUD_RUNTIME을 설정했습니다: {0}",
            ["KrRuntimeNeedsRestart"] = "이 값은 게임을 새로 켜야 반영됩니다. 프로세스는 시작할 때 환경을 물고 갑니다.",
            ...
            ["KrWaitingForDalamud"] = "Dalamud 설치가 끝나기를 기다리는 중. 이 창은 닫지 마세요.",
            ["KrDalamudArrived"] = "Dalamud가 설치됐습니다.",
            ...
            ["KrUpdaterWhatItIs2"] = "이 프로그램은 우리가 만든 것이 아니고 재배포하지도 않습니다 - 원 저장소에서 직접 받습니다.",
            ...
            ["KrLocalBuildWins"] = "로컬 빌드 {0}이 릴리스 {1}과 같거나 더 새 버전입니다 - 로컬 빌드를 사용합니다.",
            ...
            ["AutoWalkNeedsVnav2"] = "이 플러그인은 우리가 만든 것이 아니고 재배포하지도 않습니다 - 원 저장소에서 직접 받습니다.",
