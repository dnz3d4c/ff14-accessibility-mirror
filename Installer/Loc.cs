...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
    {
        [German] = new Dictionary<string, string>
        {
            ...
            ["DungeonPathsWhat1"] = "Die Kategorie \"Dungeon\" zeigt die Stationen des Wegs durch eine Instanz.",
            ["DungeonPathsWhat2"] = "Die Wegdateien stammen von einem anderen Projekt (AutoDuty) und werden dort",
            ["DungeonPathsWhat3"] = "geladen, nicht von uns weitergegeben. Ohne sie erscheint die Kategorie nicht.",
            ["AskSetupDungeonPaths"] = "Sollen die Wegdateien jetzt geladen werden?",
            ["DungeonPathsSkipped"] = "Wegdateien übersprungen. Die Kategorie \"Dungeon\" erscheint dann nicht.",
            ["DungeonPathsFolderMade"] = "Der Ordner ist trotzdem angelegt - eigene Wegdateien koennen dort hinein: {0}",
            ["DungeonPathsLabel"] = "Wegdateien",
            ["DownloadingDungeonPaths"] = "Lade die Wegdateien ...",
            ["DungeonPathsInstalled"] = "{0} Wegdateien abgelegt.",
            ["DungeonPathsUpToDate"] = "Wegdateien sind aktuell.",
            ["DungeonPathsUnchecked"] = "nicht geprüft",
            ["DungeonPathsCheckFailed"] = "Konnte nicht prüfen, ob es neuere Wegdateien gibt ({0}). Die vorhandenen bleiben.",
            ["DungeonPathsEmpty"] = "Im Archiv war keine passende Wegdatei.",
            ["DungeonPathsFailed"] = "Wegdateien fehlgeschlagen: {0}",
            ["SummaryDungeonPaths"] = "Wegdateien (Kategorie Dungeon): {0}",
        ...
        [English] = new Dictionary<string, string>
        {
            ...
            ["DungeonPathsWhat1"] = "The \"Dungeon\" category lists the stations of the way through an instance.",
            ["DungeonPathsWhat2"] = "The route files come from a different project (AutoDuty) and are fetched from",
            ["DungeonPathsWhat3"] = "there, not redistributed by us. Without them the category does not appear.",
            ["AskSetupDungeonPaths"] = "Fetch the route files now?",
            ["DungeonPathsSkipped"] = "Route files skipped. The \"Dungeon\" category will not appear.",
            ["DungeonPathsFolderMade"] = "The folder was created anyway - your own route files can go there: {0}",
            ["DungeonPathsLabel"] = "route files",
            ["DownloadingDungeonPaths"] = "Fetching the route files ...",
            ["DungeonPathsInstalled"] = "{0} route files placed.",
            ["DungeonPathsUpToDate"] = "Route files are up to date.",
            ["DungeonPathsUnchecked"] = "not checked",
            ["DungeonPathsCheckFailed"] = "Could not check for newer route files ({0}). Keeping the ones already there.",
            ["DungeonPathsEmpty"] = "The archive held no route file with a usable name.",
            ["DungeonPathsFailed"] = "Route files failed: {0}",
            ["SummaryDungeonPaths"] = "Route files (Dungeon category): {0}",
        ...
        [Korean] = new Dictionary<string, string>
        {
            ...
            ["DungeonPathsWhat1"] = "던전 분류는 던전을 지나는 길의 지점을 이동 순서대로 알려 줍니다.",
            ["DungeonPathsWhat2"] = "경로 파일은 AutoDuty 프로젝트 저장소에서 내려받습니다.",
            ["DungeonPathsWhat3"] = "경로 파일이 없으면 던전 분류가 나타나지 않습니다.",
            ["AskSetupDungeonPaths"] = "경로 파일을 내려받으시겠습니까?",
            ["DungeonPathsSkipped"] = "경로 파일을 건너뛰었습니다. 던전 분류는 나타나지 않습니다.",
            ["DungeonPathsFolderMade"] = "폴더는 만들어 두었습니다. 직접 구한 경로 파일을 여기에 넣으시면 됩니다: {0}",
            ["DungeonPathsLabel"] = "경로 파일",
            ["DownloadingDungeonPaths"] = "경로 파일을 내려받는 중입니다...",
            ["DungeonPathsInstalled"] = "경로 파일 {0}개를 넣었습니다.",
            ["DungeonPathsUpToDate"] = "경로 파일이 최신입니다.",
            ["DungeonPathsUnchecked"] = "확인 못 함",
            ["DungeonPathsCheckFailed"] = "새 경로 파일이 있는지 확인하지 못했습니다({0}). 이미 받아 둔 것을 그대로 씁니다.",
            ["DungeonPathsEmpty"] = "받은 압축 파일에 쓸 수 있는 이름의 경로 파일이 없었습니다.",
            ["DungeonPathsFailed"] = "경로 파일을 받지 못했습니다: {0}",
            ["SummaryDungeonPaths"] = "경로 파일(던전 분류): {0}",
            ["SkippedShort"] = "건너뜀",
            ["OkShort"] = "설치됨",
            ["ErrorShort"] = "실패",
